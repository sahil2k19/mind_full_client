          ...
          <div className='select-none'>
            ...
            <div class=" flex flex-col items-center justify-center bg-background text-foreground px-4">
                <div class="w-full max-w-md bg-card p-6 rounded-lg ">
                    ...
                    <button onClick={() => router.push('/consultation/location')} class="w-full font-semibold bg-primary-orange text-white py-3 rounded-lg mb-4 ">BOOK ANOTHER APPOINTMENT</button>
