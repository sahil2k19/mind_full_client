            ...
            <div class="mt-1  flex  items-center justify-center bg-background text-foreground">
                <div class="w-full max-w-md bg-card  rounded-lg lg:container p-6">
                    ...
                    <div className='flex items-center justify-center'>
                        ...
                        <button class=" w-full mt-8 py-4 bg-primary-orange px-10  rounded-lg  text-white font-semibold" onClick={() => router.push("/consultation/summary")}>BOOK APPOINTMENT</button>
                    </div>
                </div>
            </div>
        </div>
