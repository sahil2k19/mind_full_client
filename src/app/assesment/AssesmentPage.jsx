        ...
        <>
            <div>
                <div className='flex p-6 items-center'>
                    ...
                    <div>
                        <h1 class="text-2xl font- ">{allSection.section1.header}</h1>
                ...
                <div className='p-8'>
                    ...
                    <Link href={'/'}>
                            <button
                                // onClick={()=>navigate('/')}
                                className='text-white font-semibold  bg-primary-orange  active:bg-orange-400 p-4 rounded w-full'>{allSection?.section3?.button?.text}</button>
