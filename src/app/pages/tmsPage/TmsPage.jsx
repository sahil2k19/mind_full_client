...
const TmsPage = () => {
  ...
  const tabs = [
    { label: "What is TMS?", content: "What is TMS?" },
    { label: "How TMS Works?", content: "How TMS Works:" },
    { label: "What to Expect?", content: "Stages in TMS Therapy?" },
  ];
      ...
      <div>
        <section className='select-none'>
          ...
          <div className='p-6 md:px-[150px]'>
            ...
            {activeTab === 0 && (
              <div className='mb-4'>
                <h1 className='text-xl text-primary-orange mb-2 font-semibold'>{tabs[0].content}</h1>
            ...
            {activeTab === 1 && (
              <div className='mb-10'>
                <h1 className='text-xl text-primary-orange mb-4 font-semibold'>{tabs[1].content}</h1>
                <div className='mb-6'>
                  {works.map((i, index) => (
            ...
            {activeTab === 2 && (
              <div className='mb-10'>
                <h1 className='text-center text-2xl font-semibold mb-3'>{tabs[2].content}</h1>
